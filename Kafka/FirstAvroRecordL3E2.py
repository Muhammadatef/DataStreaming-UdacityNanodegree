...
# OUTPUT : 
#Objavro.codenullavro.schema�{"type": "record", "name": "com.udacity.lesson3.exercise2.click_event",
 #"fields": [{"name": "email", "type": "string"}, {"name": "timestamp", "type": "string"}, 
     #       {"name": "uri", "type": "string"}, {"name": "number", "type": "int"}]}

#{���     �����/=���*lucerocraig@gmail.com&2019-05-18T08:09:00bhttps://smith.com/list/wp-content/main/author.htm�
